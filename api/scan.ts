...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (type === ContentType.TEXT) {
            ...
            contents = { parts: [{ text: "Here is the text to analyze:" }, { text: data as string }] };
            ...
            contents = { parts: [{ text: "Here is the image to analyze:" }, { inlineData: { mimeType: mimeType, data: data } }] };
